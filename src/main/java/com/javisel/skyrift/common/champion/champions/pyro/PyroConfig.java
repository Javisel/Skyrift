...
public class PyroConfig extends ChampionConfig {
    ...
    public void configureChampion() {
        ...
        resourcePerLevel = BUILDER.comment("Resource Per Level").defineInRange("resourcePerLevel", 0D, 1, 40000);
        ...
        movementSpeed = BUILDER.comment("Base Movement Speed").defineInRange("baseMovementSpeed", 0.97D, 1, 40000);
